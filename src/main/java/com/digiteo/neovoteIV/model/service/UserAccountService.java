...
public interface UserAccountService {
    ...
    //void forgottenPasswordVoter(String email) throws UnknownIdentifierException;
    void updatePassword(String password, String token) throws InvalidTokenException, UnknownIdentifierException;
    //void updatePasswordVoter(String password, String token) throws InvalidTokenException, UnknownIdentifierException;
